...
def get_parser_top():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="User's directory is %s\nFor more log details, please see: %s"
        % (__userbase__, logfile),
    ...
    optgrp.add_argument('-c', type=str,  # metavar='Name',
                        choices=[n for n in Processor_Names
                                 if Processor_Lib[n][1] == '$sys'],
                        help="Copy processor to user's directory and exit")
